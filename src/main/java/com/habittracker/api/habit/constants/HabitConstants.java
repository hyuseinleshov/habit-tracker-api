...
public final class HabitConstants {
    ...
    public static final String NAME_LENGTH_MESSAGE = "Habit name must be between 1 and 100 characters";
    public static final String DESCRIPTION_LENGTH_MESSAGE = "Habit description must not exceed 2000 characters";
